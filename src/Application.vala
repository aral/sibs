...
namespace SmallIsBeautifulStreamer {
    ...
    public class Application : Gtk.Application {
        ...
        public Application () {
            Object(
                application_id: "com.github.aral.sibs",
                flags: ApplicationFlags.FLAGS_NONE
            );

            saved_state = new GLib.Settings ("com.github.aral.sibs.saved-state");
            ...
            // on the --help screen.
            set_option_context_summary (_("Enables you to play the Small Is Beautiful streams"));
            ...
            handle_local_options.connect((application, options) => {
                ...
                if (options.contains("version")) {
                    print (@"Small Is Beautiful Streamer $(Constants.Config.VERSION)\n");
